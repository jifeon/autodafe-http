 ...
 *
 */
var HTTPRequest = module.exports = autodafe.Request.extend(/**@lends HTTPRequest*/{
    /**
     * @protected
     */
    _props: function () {
...
//        }
    ...
    _init: function () {
        ...
        var self = this;
        this._originResponse.on('finish', function () {
...
//        }
        ...
        fileReadStream.on('error', function (e) {
            this.sendError(e, 403);
        }.bind(this));

        fileReadStream.pipe(this._originResponse);
    },
...
//        }
    ...
    redirect: function (url) {
        this._originResponse.writeHead(302, {Location: url});
        this.end();
    },

    getCookie: function (name) {
        return cookie.parse(this._originRequest.headers.cookie)[name] || null;
    },

    setCookie: function (name, value, options) {
        this._originResponse.setHeader("Set-Cookie", cookie.serialize(name, value, options));
        return this;
    },

    removeCookie: function (name, options) {
        options = options || {};
        options.expires = options.expires || new Date(1970, 0, 1);
        this._originResponse.setHeader("Set-Cookie", cookie.serialize(name, 'deleted', options));
        return this;
    }
});
